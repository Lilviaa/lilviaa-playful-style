-- 023_remove_cod_rpc.sql

-- Drop the old signature
DROP FUNCTION IF EXISTS public.create_online_order(UUID, TEXT, NUMERIC, NUMERIC, TEXT, UUID, JSONB, UUID, NUMERIC, BOOLEAN, public.offline_order_item[]);

-- Create the new signature without p_is_cod
