...
import { useFeaturedProducts, useUpdateFeaturedProducts, FeaturedProduct } from "@/lib/admin/cms-api";
...
export function FeaturedCarouselEditor() {
  ...
  const { mutate: updateFeatured, isPending: isUpdating } = useUpdateFeaturedProducts();
