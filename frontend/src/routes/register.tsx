    ...
    <div className="mx-auto flex min-h-[70vh] max-w-md flex-col items-center justify-center px-6 py-12">
      ...
      <div className="mt-8 w-full rounded-3xl bg-card p-6 shadow-cute sm:p-8">
        ...
        <button
          ...
          className="flex w-full items-center justify-center gap-2 rounded-xl border border-border bg-background px-4 py-3 text-sm font-semibold text-cocoa transition-colors hover:bg-sand"
        >
